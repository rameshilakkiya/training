    ...
    <table class="nav-justified" border="0" style="border-width: 1px; border-style: solid; background-color: #C0C0C0">
        <tr>
            ...
            <td style="height: 67px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator1" runat="server" ControlToValidate="nametext" Display="Dynamic" ErrorMessage="Enter Your Name" Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td>
            ...
            <td style="height: 78px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator2" runat="server" ControlToValidate="emailtext" Display="Dynamic" ErrorMessage="Enter EMailId" Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="height: 74px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator3" runat="server" ControlToValidate="passtext" Display="Dynamic" ErrorMessage="Enter password" Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="height: 74px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator4" runat="server" ControlToValidate="mobile" Display="Dynamic" ErrorMessage="Enter your Mobile No" Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="height: 74px" colspan="2">
                <asp:RequiredFieldValidator ID="RequiredFieldValidator5" runat="server" ControlToValidate="gender" Display="Dynamic" ErrorMessage="select " Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
        ...
        <tr>
            ...
            <td style="height: 74px" colspan="3">
                ...
                <asp:RequiredFieldValidator ID="RequiredFieldValidator7" runat="server" ControlToValidate="DropDownList1" Display="Dynamic" ErrorMessage="Choose Your Location" Font-Size="Small" ForeColor="#FF3300"></asp:RequiredFieldValidator>
            </td>
        </tr>
        <tr>
            <td colspan="4">
        ...
        <tr>
            <td>
                <a href="RegisteredUser.aspx">Do You want to know registered usersdetails? Click Here</a>
            </td>
